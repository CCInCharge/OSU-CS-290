...
function sortArr(comparator, array) {
    return array.concat().sort(comparator).reverse();
}
...
function typeComparator(auto1, auto2){
    function typeToInt(auto) {
      if (auto.toLowerCase() === "roadster") {
        return 5;
      } else if (auto.toLowerCase() === "pickup") {
        return 4;
      } else if (auto.toLowerCase() === "suv") {
        return 3;
      } else if (auto.toLowerCase() === "wagon") {
        return 2;
      } else {
        return 1;
      }
    }
    if (typeToInt(auto1.type) > typeToInt(auto2.type)) {
      return true;
    } else {
      return false;
    }
